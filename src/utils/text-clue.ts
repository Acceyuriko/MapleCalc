export const TEXT_CLUE_24 = [
  ...
  {
    question: 'It seems like the mechanics are hard at work making something!',
    answer: 'Edelstein',
  },
  {
    question:
      'Look, penguins and wolves walk with quick and short paces in Cold Field.',
    answer: 'El Nath',
  },
  {
    question: "Feels mysterious. Maybe it's a forest where fairies live?",
    answer: 'Ellinia',
  },
  {
    question:
  ...
  {
    question:
      'Feels like cute foxes in the forest will prick up their ears and appear from the woods.',
    answer: 'Fox Point Village',
  },
  {
    question:
      'Fells imposing as if brave warriors are looking determined to storm the castle.',
    answer: 'Heliseum Reclamation HQ',
  },
  {
    question:
      'Clear and cheerful music. It feels as if mushrooms are frolicking on top of the hill.',
    answer: 'Henesys',
  },
  {
    question:
      'Feels like an herb gather that came to a town surrounded by fog to dig out a mysterious 1000-year-old herb.',
    answer: 'Herb Town',
  },
  {
    question:
      'Feels like thieves are lurking around every corner looking to rob unsuspecting people.',
    answer: 'Kerning City',
  },
  {
    question:
      "Ah, feels like lying on grandma's lap on the floor of a thatched house and listening to a folk tale.",
    answer: 'Korean Folk Town',
  },
  {
    question: 'Wow, it feels like flying on a dragon through the clear skies!',
    answer: 'Leafre',
  },
  {
    question:
      'Feels like being at the quay overlooking the blue sea while watching the seagulls fly.',
    answer: 'Lith Harbor',
  },
  {
    question:
      'Feels like a town where cute toys and robots wander the streets.',
    answer: 'Ludibrium',
  },
  {
    question:
      "Wow, flying through the sky on a fancy ship! It's the stuff dreams are made of.",
    answer: 'Lumiere',
  },
  {
    question:
      'Feels tense as if looking for someone who disappeared in a dark alley.',
    answer: 'Magatia',
  },
  {
    question: 'The bears have been training with all their might since dawn.',
    answer: 'Mu Lung',
  },
  {
    question: 'Pew, pew! Fighting against alien lifeforms with a laser gun!',
    answer: 'Omega Sector',
  },
  {
    question:
      'Feels like where angels spread their wings float swiftly around town.',
    answer: 'Orbis',
  },
  {
    question:
      'Feels like visiting another planet beyond the vast expanse of space.',
    answer: 'Pantheon',
  },
  {
    question:
      'Feels like encountering a cold-hearted warrior tribe in the middle of the wilderness where the desolate winds below.',
    answer: 'Perion',
  },
  {
    question:
      'A penguin is leisurely fishing in a glacial town where everything is covered in ice.',
    answer: 'Rien',
  },
  {
    question:
      'Feels like entering a huge tree that fell asleep, strange yet familiar.',
    answer: 'Sleepywood',
  },
];

export const TEXT_CLUE_39 = [
  {
    question: 'What is the name of the broker residing in Magatia?',
    answer: ['Han the Broker'],
  },
  {
  ...
  {
    question:
      'What is the name of the dog sitting next to the Dimensional Mirror in Orbis?',
    answer: ['Moppie'],
  },
  {
  ...
  {
    question:
      'What is the name of the grandma guarding the Great Temple in Pantheon?',
    answer: ['Selene'],
  },
  {
    question:
      'What is the name of the helmsman of Riena Strait Glacial Observatory?',
    answer: ['Helmsman Tanya'],
  },
  {
  ...
  {
    question:
      'What is the name of the kid monk in front of the Golden Temple entrance?',
    answer: ['Noi'],
  },
  {
  ...
  {
    question: 'What is the name of the streetsweeper in Edelstein?',
    answer: ['Brighton'],
  },
  {
  ...
  {
    question:
      'What is the name of public service worker in Kerning City Subway?',
    answer: ['Jake'],
  },
  {
    question: 'Who in Kerning City can repair items?',
    answer: ['JM From tha Streetz'],
  },
  {
  ...
  {
    question:
      'Who is the subway worker next to the Ticket Gate in Kerning City?',
    answer: ['Jake'],
  },
  {
  ...
  },
  {
    ...
    answer: ['Rowen the Fairy'],
  },
  {
    question:
      "My hands aren't what they used to be. I really need to get me an apprentice...",
    answer: ['Potter'],
  },
  {
    question:
      "Nice weather, isn't it? It's a greay day to enjoy a walk with my pet, Muffins.",
    answer: ['Bastille'],
  },
  {
  ...
  {
    question:
      "So much homework... And so much studying to do... Man, I'm swamped.",
    answer: ['Wing the Fairy'],
  },
  {
    question:
      "That smell in the air sure does make the fur stand up, don't it?",
    answer: ['Alviola'],
  },
  {
  ...
  },
  {
    ...
    answer: ['Cootie the Really Small'],
  },
  {
  ...
  },
  {
    ...
    answer: ['Blue Flower Serpent', 'Jr. Wraith'],
  },
  {
    question: 'Which of these monsters is NOT enchanted?',
    answer: ['Antoinette', 'Goby'],
  },
  {
    question: 'Which of these monsters is NOT from the Nihal Desert?',
    answer: ['Water Thief Monster'],
  },
  {
    question: 'Which of these monsters is NOT in the Tower of Oz?',
    answer: [
  ...
  },
  {
    ...
    answer: ['Captain Latancia'],
  },
  {
    question: 'Which of these monsters is NOT undead?',
    answer: ['Pink Bean', 'Snipe of Competence'],
  },
  {
